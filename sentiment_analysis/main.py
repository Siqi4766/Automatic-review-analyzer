...
print("{:35} {:.4f}".format("Test accuracy for Pegasos:", test_accuracy))
...
negative_word_features = utils.most_explanatory_word(-best_theta, wordlist)
print("Most Explanatory Negative Word Features")
print(negative_word_features[:10])
